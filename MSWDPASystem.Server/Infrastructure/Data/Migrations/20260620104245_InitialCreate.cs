    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HouseholdNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Barangay = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HeadOfHouseholdName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Beneficiaries_Households_HouseholdId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    WelfareProgramId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssistanceTypes_WelfarePrograms_WelfareProgramId",
                        column: x => x.WelfareProgramId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WelfareProgramId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeneficiaryPrograms", x => new { x.BeneficiaryId, x.WelfareProgramId });
                    table.ForeignKey(
                        name: "FK_BeneficiaryPrograms_Beneficiaries_BeneficiaryId",
                        column: x => x.BeneficiaryId,
                        principalTable: "Beneficiaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BeneficiaryPrograms_WelfarePrograms_WelfareProgramId",
                        column: x => x.WelfareProgramId,
                        principalTable: "WelfarePrograms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_Beneficiaries_BeneficiaryId",
                        column: x => x.BeneficiaryId,
                        principalTable: "Beneficiaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OriginalBeneficiaryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DuplicateBeneficiaryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    FlaggedBySystem = table.Column<bool>(type: "bit", nullable: false),
                    FlaggedByUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DuplicateFlags_Beneficiaries_DuplicateBeneficiaryId",
                        column: x => x.DuplicateBeneficiaryId,
                        principalTable: "Beneficiaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DuplicateFlags_Beneficiaries_OriginalBeneficiaryId",
                        column: x => x.OriginalBeneficiaryId,
                        principalTable: "Beneficiaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QrScanLogs_Beneficiaries_BeneficiaryId",
                        column: x => x.BeneficiaryId,
                        principalTable: "Beneficiaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeniedByUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssistanceRequests_AssistanceTypes_AssistanceTypeId",
                        column: x => x.AssistanceTypeId,
                        principalTable: "AssistanceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssistanceRequests_Beneficiaries_BeneficiaryId",
                        column: x => x.BeneficiaryId,
                        principalTable: "Beneficiaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssistanceRequests_WelfarePrograms_WelfareProgramId",
                        column: x => x.WelfareProgramId,
                        principalTable: "WelfarePrograms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                name: "AssistanceRequestStatusHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssistanceRequestId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssistanceRequestStatusHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssistanceRequestStatusHistories_AssistanceRequests_AssistanceRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssistanceRequests_AssistanceTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssistanceRequests_RequestNumber",
                table: "AssistanceRequests",
                column: "RequestNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AssistanceRequests_WelfareProgramId",
                table: "AssistanceRequests",
                column: "WelfareProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_AssistanceRequestStatusHistories_AssistanceRequestId",
                table: "AssistanceRequestStatusHistories",
                column: "AssistanceRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_AssistanceTypes_WelfareProgramId",
                table: "AssistanceTypes",
                column: "WelfareProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_Beneficiaries_ClientNumber",
                table: "Beneficiaries",
                column: "ClientNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BeneficiaryPrograms_WelfareProgramId",
                table: "BeneficiaryPrograms",
                column: "WelfareProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_Documents_BeneficiaryId",
                table: "Documents",
                column: "BeneficiaryId");

            migrationBuilder.CreateIndex(
                name: "IX_DuplicateFlags_DuplicateBeneficiaryId",
                table: "DuplicateFlags",
                column: "DuplicateBeneficiaryId");

            migrationBuilder.CreateIndex(
                name: "IX_DuplicateFlags_OriginalBeneficiaryId",
                table: "DuplicateFlags",
                column: "OriginalBeneficiaryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QrScanLogs_BeneficiaryId",
                table: "QrScanLogs",
                column: "BeneficiaryId");
        }
