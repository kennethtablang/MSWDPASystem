...
namespace MSWDPASystem.Server.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260719020938_AddRelationshipsAndAssistedService")]
    partial class AddRelationshipsAndAssistedService
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSWDPASystem.Server.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<Guid?>("LinkedBeneficiaryId")
            ...
            modelBuilder.Entity("MSWDPASystem.Server.Domain.Entities.SystemSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MSWDPASystem.Server.Domain.Entities.ApplicationUser", b =>
                {
                    b.HasOne("MSWDPASystem.Server.Domain.Entities.Beneficiary", "LinkedBeneficiary")
                        .WithMany()
                        .HasForeignKey("LinkedBeneficiaryId");

                    b.Navigation("LinkedBeneficiary");
                });
